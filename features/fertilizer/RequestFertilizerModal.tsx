...
interface ModalInterface {
    isOpen: boolean;
    onClose: () => void;
    requestFertilizerForm: UseFormReturn<any>
...
export default function RequestFertilizerModal({
    isOpen,
    onClose,
    ...
    const { register, setValue, watch, formState, handleSubmit, reset } = requestFertilizerForm
            ...
            <ModalContent>
                ...
                <ModalBody>
                    <Box as={'form'} onSubmit={handleSubmit(async (payload) => {
                        ...
                        <Text fontWeight={"semibold"}>Nama Barang: {selectedData?.nama || '-'}</Text>
                        ...
                        <FormControl pt={4} mb={4} isInvalid={errors?.jumlah?.message ? true : false}>
                            <FormLabel>Jumlah Barang Diminta</FormLabel>
