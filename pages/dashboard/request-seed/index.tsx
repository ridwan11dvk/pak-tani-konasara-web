...
const RequestSeed = (): JSX.Element => {
    ...
    return (
        <>
            <Head>
                <title>Permintaan Bibit - Pak Tani Konasara</title>
            </Head>
            <Layout menuName='Permintaan Bibit'>
                <Box p={isMobile ? 4 : 8} overflowX={"auto"}>
                    <VStack gap={8} alignItems="start">
                        <InputGroup >
                            <Input value={search} onChange={(e) => setSearch(e.target.value)}
                                placeholder='Cari Bibit' backgroundColor="white"
                            />
                            <InputRightElement >
                                <Icon as={BsSearch} />
                            </InputRightElement>
              ...
              Tambah Lahan
                    ...
                    <RequestSeedModal
                        onSubmit={onSubmit}
                        requestSeedForm={requestSeedForm}
                        isOpen={isOpen}
